...
| 正式部署 Doctor frontend | `2.2.0` | 2026-09-09 | 七段醫師摘要逐欄確認，依 UCC scope 與可信任 FHIR context 寫入 preliminary Composition | [frontend-v2/README.md](frontend-v2/README.md#service-versions) |
...
`1.1.2` 基線維護。Doctor app 與 Patient app 目前皆為 `2.2.0`。
