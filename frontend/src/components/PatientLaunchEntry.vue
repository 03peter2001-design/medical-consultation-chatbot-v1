  ...
  <section class="patient-launch-entry" aria-labelledby="launch-entry-title">
    <div class="launch-entry-heading">
      <div>
        ...
        <h3 id="launch-entry-title">掃描 QR 或貼上一次性 code</h3>
      </div>
      <button
        class="scan-button"
        type="button"
    ...
    <form class="launch-code-form" @submit.prevent="redeem">
      <label for="patient-launch-code">一次性問診 code</label>
...
.patient-launch-entry {
  ...
  gap: 12px;
  padding: 16px;
  border: 1px solid rgb(10 146 126 / 28%);
  border-radius: 14px;
  background: rgb(235 250 246 / 72%);
  text-align: left;
}
