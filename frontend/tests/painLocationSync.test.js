...
} from '../src/services/painLocationSync.js'
...
const painLocationInput = readFileSync(
  new URL('../src/components/PainLocationInput.vue', import.meta.url),
  'utf8',
)
const bodyPainMap = readFileSync(
  new URL('../src/components/BodyPainMap.vue', import.meta.url),
  'utf8',
)
